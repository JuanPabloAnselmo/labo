...
source("~/labo2023ba/src/workflow-inicial/631_FE_historia_02_sc.r")
source("~/labo2023ba/src/workflow-inicial/641_TS_training_strategy_02_B.r")

# ultimos pasos, muy lentos
source("~/labo2023ba/src/workflow-inicial/651_HT_lightgbm_01.r")
source("~/labo2023ba/src/workflow-inicial/661_ZZ_final_02_sc.r")
